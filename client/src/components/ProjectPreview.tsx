...
const ProjectPreview = forwardRef<ProjectPreviewRef, ProjectPreviewProps>(({project,
     isGenerating, device = 'desktop', showEditorPanel = true}, ref) => {
        ...
        useImperativeHandle(ref, ()=>({
            getCode: ()=>{
                ...
                // 2. Remove the injected style + script from the document
        ...
        const injectPreviewCode = (html: string) =>{
            if(!html) return '';
