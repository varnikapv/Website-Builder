...
export const stripeWebhook = async (request: Request, response: Response) => {
  // Remove duplicate Stripe initialization - you only need one
  ...
  if (endpointSecret) {
    ...
    return response.json({ received: true }); // Added return statement
  }
  
  // Handle case when endpointSecret is not provided
